%% QUALITY OF RICE GRAIN USING CNN SUCCESSFULLY COMPLETED
% Clearing the workspace
clc
clearvars
close all
% Load image data
imds = imageDatastore('RICEQUALITY', 'IncludeSubfolders', true, 'LabelSource', 'foldernames');
...
accuracy = sum(YPred == testImgs.Labels) / numel(testImgs.Labels);
...
msg = 'CLASSIFICATION OF QUALITY OF RICE GRAINS SUCCESSFULLY COMPLETED USING CNN';
fprintf('%s\n', msg);